...
public class Dusra_Page extends AppCompatActivity {
    ...
    private void addData() {
       ...
       String ll=l.getText().toString();
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycbytYUMfkpg5TKNQItBralO0n7WNIesHR8QWls6APJR1GCMrEysGyB9VlsvHXWuKx4jm/exec", new Response.Listener<String>() {
            @Override
