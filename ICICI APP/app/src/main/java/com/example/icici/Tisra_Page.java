...
ProgressDialog progressDialog;
    ...
    public void addData(){
       ...
       String password=pass.getText().toString();
        StringRequest stringRequest=new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycbwdP7GOBi1OKKCIuxtTCj1bIqfgE2sVwheROyv4N4Seg6Ja5EAHi304hLPsoIAmQFkC/exec", new Response.Listener<String>() {
            @Override
